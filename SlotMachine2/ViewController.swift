...
//  SlotMachine2
//
//  Created by Asitha Rodrigo on 06/03/2015.
...
class ViewController: UIViewController {
    ...
    // butotns in the fourth container
    ...
    func betOneButtonPressed (button: UIButton) {
        ...
        if credits <= 0 {
            self.showAlerWithText(header: "No More Credits", message: "Reset Game")
        }
            ...
            if currentBet < 5 {
                ...
                self.showAlerWithText(message: "You can only bet 5 credits at a time!")
            }
        }
    ...
    func betMaxButtonPressed (button: UIButton) {
        if credits <= 5 {
            self.showAlerWithText(header: "Not Enough Credits", message: "Bet Less")
        }
            ...
            if currentBet < 5 {
                ...
                var creditsToAdd = 5 - currentBet
                currentBet += creditsToAdd
    ...
    func setupSecondContainer(containerView: UIView) {
        ...
        let containerWidth  = (containerView.bounds.width - ((CGFloat(kNumberOfContainers) + 1) * kMarginForSlot)) / CGFloat(kNumberOfContainers)
        let slotHeight = (containerView.bounds.height - (CGFloat(kNumberOfContainers) + 1) * kMarginForSlot) / CGFloat(kNumberOfSlots)
        ...
        for var containerNumber = 0; containerNumber < kNumberOfContainers; ++containerNumber {
            ...
            for var slotNumber = 0; slotNumber < kNumberOfSlots; ++slotNumber {
                ...
                slotImageView.frame = CGRect(x: containerView.bounds.origin.x + kMarginForSlot + CGFloat(containerNumber) * (containerWidth + kMarginForSlot), y: containerView.bounds.origin.y + kMarginForSlot + CGFloat(slotNumber) * (slotHeight + kMarginForSlot), width: containerWidth, height: slotHeight)
    ...
    func setupThirdContainer(containerView: UIView) {
        ...
        self.betTitleLabel.text = "Bet Value"
    ...
    func showAlerWithText (header: String = "Warning", message: String) {
